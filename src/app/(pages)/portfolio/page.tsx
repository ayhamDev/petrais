          ...
          <div className="flex justify-between items-center gap-32 lg:flex-row flex-col-reverse">
            <div className="flex-1">
              <AnimateContainer>
                ...
                >
                  ...
                  pellentesque. Odio nunc sapien ornare a sed venenatis nunc id.
                  Dui ullamcorper sagittis eu magna. Ornare gravida dignissim
                  sed lacus ac. Volutpat odio et non velit sapien enim dui lacus
                  pellentesque. Vitae faucibus integer senectus ut libero diam
                  in iaculis. Tempor et hac eu tortor amet sed. Viverra aliquam
                  eleifend vestibulum quis orci quis. Ac tellus diam nibh
                  pharetra quis urna volutpat at amet. Accumsan faucibus quam
                  auctor sed commodo non elit purus et. Erat venenatis donec
                  gravida aliquam scelerisque scelerisque magna. Mattis mollis
                  enim.
                </Typography>
              </AnimateContainer>
            </div>
            <div className="flex-1">
              <AnimateContainer type="fade">
                <Image src={headerImg} alt="portfolio" />
              </AnimateContainer>
            </div>
          </div>
        </Wrapper>
